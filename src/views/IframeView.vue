...
const legacyCss = `
  ...
  *,*::before,*::after{box-sizing:border-box}
  ...
  body.fm-legacy-skin .modal-content,
  ...
  body.fm-legacy-skin .modal-header{
    ...
    padding:11px 84px 11px 16px!important;
    border:0!important;
    border-bottom:1px solid var(--fm-border)!important;
    background:#fff!important;
    color:var(--fm-text)!important;
  ...
  body.fm-legacy-skin .fm-legacy-maximize{
  ...
  body.fm-legacy-skin .fm-legacy-maximize:hover{
    background:var(--fm-cyan-soft)!important;
    color:var(--fm-cyan-strong)!important;
  }
  body.fm-legacy-skin .fm-legacy-dialog--maximized{
  ...
  body.fm-legacy-skin .fm-legacy-dialog--maximized .ui-dialog-content,
  body.fm-legacy-skin .fm-legacy-dialog--maximized .p-dialog-content,
  body.fm-legacy-skin .fm-legacy-dialog--maximized .modal-body{
  ...
  @media(max-width:760px){
    ...
    body.fm-legacy-skin .ui-dialog,
    body.fm-legacy-skin .p-dialog,
    body.fm-legacy-skin .modal-content{width:calc(100vw - 20px)!important}
    body.fm-legacy-skin .fm-legacy-dialog--maximized{inset:8px!important;height:calc(100vh - 16px)!important}
  }
`
...
const applyLegacyStyles = () => {
  try {
    ...
    legacyObserver?.disconnect()
    legacyObserver = new MutationObserver(() => enhanceDialogs(document))
