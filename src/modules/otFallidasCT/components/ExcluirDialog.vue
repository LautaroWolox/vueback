...
watch(
  () => commonCT.status.motivos,
  status => {
    if (status === 'error') {
      commonCT.setMotivosExcInc()
    }
  }
)
...
:deep(.otf-motivo-select .fm-compact-select__trigger) {
  height: 32px;
  min-height: 32px;
  padding: 0 8px;
  font-size: 11px;
...
:deep(.otf-motivo-select .fm-compact-select__value) {
  font-size: 11px;
  font-weight: 400;
}

:deep(.otf-motivo-select .fm-compact-select__chevron) {
  width: 7px;
  height: 7px;
  flex-basis: 7px;
...
:deep(.otf-motivo-select .fm-compact-select__panel) {
  padding: 2px 0;
}

:deep(.otf-motivo-select .fm-compact-select__option) {
  min-height: 27px;
  padding: 4px 8px;
  font-size: 11px;
  font-weight: 400;
